    ...
    public class ScoalaController : ControllerBase
    {
        ...
        public List<ScoalaDetailsDTO> Get()
        {
            ...
            foreach(Scoala MyScoala in MyScoli)
            {
                ...
                ScoalaDetailsDTO MyScoalaDetailsDTO = new ScoalaDetailsDTO()
                {
                    ...
                    Mscolar = MyScoala.Mscolar,
                    Romani = MyScoala.Romani,
                    Finantari = MyScoala.Finantari,
                    Plan = MyScoala.Plan,
                    Msanitar = MyScoala.Msanitar,
                    Expert = MyScoala.Expert
    };
        ...
        public ScoalaDetailsDTO Get(int id)
        {
            ...
            ScoalaDetailsDTO MyScoala = new ScoalaDetailsDTO()
            {
                ...
                Mscolar = Scoala.Mscolar,
                Romani = Scoala.Romani,
                Finantari = Scoala.Finantari,
                Plan = Scoala.Plan,
                Msanitar = Scoala.Msanitar,
                Expert = Scoala.Expert
            };
